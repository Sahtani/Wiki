                    ...
                    <div class="cursor-pointer border border-beige p-4 rounded-lg overflow-hidden group shadow-xl">
                        ...
                        <div class=" mt-4 flex items-center justify-end gap-4 border-t bg-white w-full">
                            <?php if ($wiki['archive'] === 0) : ?>
                                <a href="<?= BASE_URL ?>/wiki/archive_wiki/<?= $wiki['idwiki'] ?>" title="Archive" class="mt-4 text-white ">
                            ...
                            <?php endif; ?>
                            <a href="<?= BASE_URL ?>/wiki/unrarchiveWiki/<?= $wiki['idwiki'] ?>">
                                <p text-mr underline>unarchive</p>
                            </a>
