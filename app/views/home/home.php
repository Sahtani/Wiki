...
<div class="grid grid-cols-1 md:grid-cols-3 ml-10 mt-10 gap-6  ">
    ...
    ?>
            <div class="  px-8 lg:mt-16 max-w-sm ">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 lg:gap-8 gap-12 items-center md:max-w-7xl max-w-lg mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:col-span-2">
            <div class="cursor-pointer rounded overflow-hidden group">
                <img src="https://readymadeui.com/Imagination.webp" alt="Blog Post 1" class="w-full h-52 object-cover" />
                <div class="py-6">
            ...
            <div class="cursor-pointer rounded overflow-hidden group">
                ...
                <div class="py-6">
                    ...
                    <h3 class="text-xl font-bold text-[#333] group-hover:text-blue-500 transition-all">Innovators Changing the Game</h3>
                </div>
            </div>
        </div>
    </div>
