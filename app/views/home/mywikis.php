...
<div class="grid grid-cols-1 md:grid-cols-3 ml-10 md:gap-6">
    ...
    ?>
            <div class=" w-80 rounded-lg bg-baigebeige  font-[sans-serif]   lg:mt-16  rounded-lg ">
                ...
                <div class="flex items-center ">
                    <h2 class=" pl-4 text-mr font-mono text-SM underline p-2 mt-4">title:</h2>
                    <h2 class="pl-4 font-mono text-mr text-1xl font-bold pt-4"><?= $wiki['title'] ?></h2>
                </div>
                <div class="w-5/6 m-auto">
                </div>

                <p class="truncate mt-4 text-sm text-gray-500">
                    <?= substr($wiki['content'], 0, 200) . (strlen($wiki['content']) > 150 ? '...' : ''); ?>
                </p>

                <p class=" break-normal  font-mono text-gray-800 pl-2 pt-6 text-wrap"><?= $wiki['dateCreation'] ?></p>
                <div class="flex items-center ml-2 mt-6">
                    <div>
                        ...
                        ?>
                            ...
                            <div class="text-xs inline-flex items-center font-bold leading-sm  px-3 py-1 bg-verblanc text-mr rounded-full">
                                <span>#</span>
                                <p><?= $tag["name"]; ?></p>
                ...
                <div class=" mt-4 flex items-center justify-end gap-4 border border-t bg-verblanc ">
                    ...
                    <a href="<?= BASE_URL ?>/wiki/signlepage/<?= $wiki['idwiki'] ?>" title="View more" class="  mr-2 ">
