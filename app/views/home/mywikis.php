...
<div class="grid grid-cols-1 md:grid-cols-4 mt-6 ml-10 ">
    <a href="<?= BASE_URL ?>/wiki/formwiki">
        add wiki
    </a>
    <?php var_dump($wikis);
    die();
    ...
    ?>
        <div class=" w-100 mt-24 lg:mt-16 max-w-sm ">

            <div class=" bg-baigebeige shadow-2xl ">
                <div class=" flex items-center ">
                    <h2 class=" pl-4 text-gray-800 text-xs p-2 mt-4 underline">Categorie:</h2>
                    <h2 class="pl-4 text-gray-800 text-2xl font-bold pt-4">Order Summary</h2>
                </div>
                <div class="w-5/6 m-auto">
                </div>
                <div class="bg-baigebeige  ">
                    <div class="flex items-center ">
                        <h2 class=" pl-4 text-mr text-xs underline p-2 mt-4">title:</h2>
                        <h2 class="pl-4 text-mr text-2xl font-bold pt-4">Order Summary</h2>
                    </div>
                    <div class="w-5/6 m-auto">
                    </div>


                    <p class=" text-gray-800 pl-2 pt-6">You can now listen to millions of songs, audiobooks ands podcasts on any device anywhere you like!</p>
                    <div class="flex items-center justify-center mt-6">
                        <div>
                            ...
                            <div class="ml-4 text-xs inline-flex items-center font-bold leading-sm uppercase px-3 py-1 bg-green-200 text-green-700 rounded-full">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-right mr-2">
                            ...
                            <div class="ml-4 text-xs inline-flex items-center font-bold leading-sm uppercase px-3 py-1 bg-red-200 text-red-700 rounded-full">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-archive mr-2">
